...
public class SysMenuController {
    ...
    public QueryByPageOutDTO queryByPage(@RequestBody QueryByPageDTO queryByPageDTO) {
        QueryByPageOutDTO outDTO = this.sysMenuService.queryByPage(queryByPageDTO);
        return outDTO;
    }
    ...
    public QueryByIdOutDTO queryById(@RequestBody QueryByIdDTO dto) {
        QueryByIdOutDTO outDTO = this.sysMenuService.queryById(dto.getId());
        return outDTO;
    }
    ...
    public AddOutDTO add(@RequestBody AddDTO dto) {
        AddOutDTO outDTO = sysMenuService.insert(dto);
        return outDTO;
    }
    ...
    public EditOutDTO edit(@RequestBody EditDTO dto) {
        EditOutDTO outDTO = sysMenuService.update(dto);
        return outDTO;
    }
    ...
    public DeleteByIdOutDTO deleteById(@RequestBody DeleteByIdDTO dto) {
        DeleteByIdOutDTO outDTO = sysMenuService.deleteById(dto);
        return outDTO;
    }
