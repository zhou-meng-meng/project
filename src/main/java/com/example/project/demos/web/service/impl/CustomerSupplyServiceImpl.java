...
public class CustomerSupplyServiceImpl  implements CustomerSupplyService {
    ...
    public AddOutDTO insert(AddDTO dto) {
        ...
        try{
            ...
            AddPayBySystemDTO addDTO = new AddPayBySystemDTO(null,null,code,null,new BigDecimal(0),new BigDecimal(0),null,new BigDecimal(0),new BigDecimal(0),new BigDecimal(0),new BigDecimal(0),new BigDecimal(0),"1",null,SysEnums.SYS_YES_FLAG.getCode(),Constants.SYSTEM_CODE,date,"默认往来账");
